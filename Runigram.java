...
public class Runigram {
    ...
    int red   = (int)(c1.getRed() * alpha + c2.getRed() * (1.0 - alpha));
    int green = (int)(c1.getGreen() * alpha + c2.getGreen() * (1.0 - alpha));
    int blue  = (int)(c1.getBlue() * alpha + c2.getBlue() * (1.0 - alpha));
